...
import Industries from '@/components/Product/BulkSms/Industries';
import Client from '@/components/Product/Clients';
  ...
  return (
    <div>
      ...
      <div className="container py-5">
        ...
        <div className={`${styles["para-color aos"]} row para-color align`}>
