...
import styles from "./Testimonials.css"; // Import the CSS module
              ...
              <div className="row gx-4 gy-4">
                {group.map((testimonial, idx) => (
                  <div key={idx} className="col-md-6">
                    <div
                      className={`testimonialCard position-relative`}
                      data-aos="zoom-in"
                    >
                      <div className={`quoteIcon position-absolute text-primary`}>
