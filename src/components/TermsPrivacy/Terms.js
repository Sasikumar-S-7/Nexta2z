...
<section class=" container py-5 para-color" >
            <h2>Terms and Condition</h2>
            <h4>Welcome to a2zsms!</h4>
            <p>These terms and conditions outline the rules and regulations for the use of a2z SMS's Website,
                located at https://a2zsms.in/. <br></br>
                By accessing this website we assume you accept these terms and conditions. Do not continue to
                use a2zsms if you do not agree to take all of the terms and conditions stated on this page. <br></br>
                ...
                referring to same.</p>
            <h4>Cookies</h4>
            <p>We employ the use of cookies. By accessing a2zsms, you agreed to use cookies in agreement with
                the a2z SMS's Privacy Policy. <br></br>
            ...
            <h4>License</h4>
            <p>Unless otherwise stated, a2z SMS and/or its licensors own the intellectual property rights for all
                material on a2zsms. All intellectual property rights are reserved. You may access this from a2zsms
                for your own personal use subjected to restrictions set in these terms and conditions.</p>
            <p>You must not:</p>
            <ul>
                <li>Republish material from a2zsms</li>
                <li>Sell, rent or sub-license material from a2zsms</li>
                <li>Reproduce, duplicate or copy material from a2zsms</li>
                <li>Redistribute content from a2zsms</li>
            </ul>
            <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
                certain areas of the website. a2z SMS does not filter, edit, publish or review Comments prior to their
                presence on the website. Comments do not reflect the views and opinions of a2z SMS,its agents
                and/or affiliates. Comments reflect the views and opinions of the person who post their views and
                opinions. To the extent permitted by applicable laws, a2z SMS shall not be liable for the Comments
                or for any liability, damages or expenses caused and/or suffered as a result of any use of and/or
                posting of and/or appearance of the Comments on this website. <br></br>
                a2z SMS reserves the right to monitor all Comments and to remove any Comments which can be
            ...
            <p>You hereby grant a2z SMS a non-exclusive license to use, reproduce, edit and authorize others to
            ...
            <p>These organizations may link to our home page, to publications or to other Website information so
                long as the link: <br></br> (a) is not in any way deceptive;<br></br> (b) does not falsely imply sponsorship,
                endorsement
                or approval of the linking party and its products and/or services; and <br></br>(c) fits within the context of
                the
            ...
            <p>We will approve link requests from these organizations if we decide that: (a) the link would not make
                ...
                absence of a2z SMS; and (d) the link is in the context of general resource information.
            </p>
        </section>
